        ...
        <div className='container'>
            <div className='row justify-content-between'>
                <div className='col-md-4'>
                    <div className={text4.text4 + ' ' + text4.text4Label + ' ' + text4.text4_fszP16  + ' ' + text4.text4_h2fw700}>
                        <h2 className='mb-4'>Have any questions?</h2>
                        ...
                        <div className='socialIcons d-flex flex-wrap mt-4 pt-2'>
