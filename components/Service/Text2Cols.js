  ...
  return (
    ...
    <section className={styles.Text2Cols + ' default-pb1 default-pt1 position-relative'}>
        <div className="container">
            <div className='row justify-content-between'>
                <div className='col-md-5'>
                    <div className={text4.text4 + ' ' + text4.text4Label + ' ' + text4.text4_h2fw700}>
                        ...
                        <h2 className='mb-2 mb-sm-4 mb-md-5'>A smart workspace for your company</h2>
                        ...
                        <Link href="/contact-us" className='underlineBtn mt-3 d-none d-md-inline-block'>Find a private workspace</Link>
                    </div>
                </div>
                <div className='col-md-7 col-lg-6 mt-4 mt-md-0'>
                    <div className='row'>
                        <div className='col-6 mt80px'>
            ...
            <Link href="/contact-us" className='underlineBtn mt-4 pt-3 d-inline-block d-md-none'>Find a private workspace</Link>
        </div>
    </section>
    </>
  );
