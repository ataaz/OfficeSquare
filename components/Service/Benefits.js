  ...
  return (
    ...
    <section className={styles.Text2Cols + ' default-pt2 default-pb1 position-relative'}>
        <div className="container EvenOrderRow">
            <div className='row align-items-center default-pb2 justify-content-between mobilePad1'>
                ...
                <div className='col-md-5'>
                    <div className={text4.text4 + ' ' + text4.text4Label + ' '  + text4.text4_fszP16 + ' ' + text4.text4HideLabel}>
                        ...
                        <h2 className='mt-3 mt-md-0 mb-2 mb-xl-4 text4MobileBenefits'>Natural Sunlight</h2>
            ...
            <div className='row align-items-center default-pb2 default-pt2 justify-content-between mobilePad2'>
                <div className='col-md-6'>
                    <div className='imgMagnify fullImg'>
                ...
                <div className='col-md-5'>
                    <div className={text4.text4 + ' ' + text4.text4Label + ' '  + text4.text4_fszP16 + ' ' + text4.text4HideLabel}>
                        <span><em>Benefit</em></span>
                        <h2 className='mt-3 mt-md-0 mb-2 mb-xl-4 text4MobileBenefits'>Strong Wifi</h2>
            ...
            <div className='row align-items-center default-pt2 justify-content-between mobilePad3'>
                <div className='col-md-6'>
                    <div className='imgMagnify fullImg'>
                ...
                <div className='col-md-5'>
                    <div className={text4.text4 + ' ' + text4.text4Label + ' '  + text4.text4_fszP16 + ' ' + text4.text4HideLabel}>
                        <span><em>Benefit</em></span>
                        <h2 className='mt-3 mt-md-0 mb-2 mb-xl-4 text4MobileBenefits'>Ergonomic Spaces</h2>
