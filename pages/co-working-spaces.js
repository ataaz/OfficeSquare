...
// import { getCoworkingSpaces } from "../redux/CoworkingSpacesRedux";
// import { useEffect } from 'react';
// import AOS from  'aos';
// import 'aos/dist/aos.css';

export const getServerSideProps = async () => {
  const res = await fetch('https://api.officesquare.com/wp-json/wp/v2/services?slug=co-working-spaces')
  const page = await res.json()
  return { props: { page } }
}

export default function CoworkingSpaces({ page }) {
  return (
    <>
    <Layout>
      <Head>
